...
import "./UpdatedListing.css"; // Ensure this CSS file is created
import {
  getDownloadURL,
  getStorage,
  ref,
...
const UpdatedListingComp = ({ listingId }) => {
  ...
  useEffect(() => {
    const fetchListing = async () => {
      const res = await fetch(`https://api-real-estate-ten.vercel.app/api/listing/get/${listingId}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setLoading(true);
      setError(false);
      const res = await fetch(`https://api-real-estate-ten.vercel.app/api/listing/update/${listingId}`, {
        method: "POST",
        headers: {
